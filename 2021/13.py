...
def part1():
    ...
    visible_dots_p1 = visible_dots.copy()
    if instruction[0] == "x":
        visible_dots_p1 = x_fold(instruction[1], visible_dots)
    else:
        visible_dots_p1 = y_fold(instruction[1], visible_dots)
    print(len(visible_dots_p1))
